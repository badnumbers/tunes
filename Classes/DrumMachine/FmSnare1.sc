FmSnare1 : TouchOscSynth {
    *new {
		^super.new(\fm_snare_1,
			...
			[
				TouchOscControlSpec(\fmAlevel, "FM A Level", '/pages/2/rows/1/rotaries/1', 0, 1),
				TouchOscControlSpec(\fmBlevel, "FM B Level", '/pages/2/rows/1/rotaries/2', 0, 1),
				TouchOscControlSpec(\fmenvtofreq, "FM Env to Freq", '/pages/2/rows/1/rotaries/3', 0.01, 100, \exp),
				TouchOscControlSpec(\fmA1freq, "FM A Freq 1", '/pages/2/rows/2/rotaries/1', 20, 2000, \exp),
				TouchOscControlSpec(\fmA1amt, "FM A 1 Amt", '/pages/2/rows/2/rotaries/2', 0, 1),
				TouchOscControlSpec(\fmA2freq, "FM A Freq 2", '/pages/2/rows/2/rotaries/3', 20, 2000, \exp),
				TouchOscControlSpec(\fmA2amt, "FM A 2 Amt", '/pages/2/rows/2/rotaries/4', 0, 1),
				TouchOscControlSpec(\fmA3freq, "FM A Freq 3", '/pages/2/rows/2/rotaries/5', 20, 2000, \exp),
				TouchOscControlSpec(\fmAenvatttime, "FM A Env Att", '/pages/2/rows/3/rotaries/1', 0.001,1, \exp),
				TouchOscControlSpec(\fmAenvdectime, "FM A Env Dec", '/pages/2/rows/3/rotaries/2', 0.001,1, \exp),
				TouchOscControlSpec(\fmAenvdeccurve, "FM A Env Dec Curve", '/pages/2/rows/3/rotaries/3', -5, 5),
				TouchOscControlSpec(\fmAfreqscale, "FM A Freq Scale", '/pages/2/rows/3/rotaries/5', 0.25, 4, \exp),

				TouchOscControlSpec(\fmB1freq, "FM B Freq 1", '/pages/2/rows/4/rotaries/1', 20, 2000, \exp),
				TouchOscControlSpec(\fmB1amt, "FM B 1 Amt", '/pages/2/rows/4/rotaries/2', 0, 1),
				TouchOscControlSpec(\fmB2freq, "FM B Freq 2", '/pages/2/rows/4/rotaries/3', 20, 2000, \exp),
				TouchOscControlSpec(\fmB2amt, "FM B 2 Amt", '/pages/2/rows/4/rotaries/4', 0, 1),
				TouchOscControlSpec(\fmB3freq, "FM B Freq 3", '/pages/2/rows/4/rotaries/5', 20, 2000, \exp),
				TouchOscControlSpec(\fmBenvatttime, "FM B Env Att", '/pages/2/rows/5/rotaries/1', 0.001,1, \exp),
				TouchOscControlSpec(\fmBenvdectime, "FM B Env Dec", '/pages/2/rows/5/rotaries/2', 0.001,1, \exp),
				TouchOscControlSpec(\fmBenvdeccurve, "FM B Env Dec Curve", '/pages/2/rows/5/rotaries/3', -5, 5),
				TouchOscControlSpec(\fmBfreqscale, "FM B Freq Scale", '/pages/2/rows/5/rotaries/5', 0.25, 4, \exp),

				TouchOscControlSpec(\noiselevel, "Noise Level", '/pages/2/rows/6/rotaries/1', 0, 1),
				TouchOscControlSpec(\noiselpf, "Noise LPF", '/pages/2/rows/6/rotaries/2', 200, 20000, \exp),
				TouchOscControlSpec(\noisehpf, "Noise HPF", '/pages/2/rows/6/rotaries/3', 200, 20000, \exp),
				TouchOscControlSpec(\noiseenvatttime, "Noise Env Att", '/pages/2/rows/7/rotaries/1', 0.001,1, \exp),
				TouchOscControlSpec(\noiseenvdectime, "Noise Env Dec", '/pages/2/rows/7/rotaries/2', 0.001,1, \exp),
				TouchOscControlSpec(\noiseenvdeccurve, "Noise Env Dec Curve", '/pages/2/rows/7/rotaries/3', -5, 5),
				TouchOscControlSpec(\revlevel, "Reverb Level", '/pages/2/rows/8/rotaries/1', 0, 1),
				TouchOscControlSpec(\revroomsize, "Reverb Room Size", '/pages/2/rows/8/rotaries/2', 0, 1),
				TouchOscControlSpec(\revdamping, "Reverb Damping", '/pages/2/rows/8/rotaries/3', 0, 1),
				TouchOscControlSpec(\boost, "Boost", '/pages/2/rows/8/rotaries/4', 1, 20, \exp),
				TouchOscControlSpec(\attenuation, "Attenuation", '/pages/2/rows/8/rotaries/5', 0, 1)
			],
			(
				'Dumf':(
