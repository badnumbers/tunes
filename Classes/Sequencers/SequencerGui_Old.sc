SequencerGui_Old {
	...
	init {
		...
		Validator.validateMethodParameterType(sequencer, Sequencer_Old, "sequencer", "SequencerGui_Old", "init");
	...
	*new {
		|sequencer,privateSequencerData|
		Validator.validateMethodParameterType(sequencer, Sequencer_Old, "sequencer", "SequencerGui_Old", "new");
	...
	prSelectPattern {
		...
		var parentPatternText = PatternText(Sequencer_Old, nil, index);
